...
const KiemTraNangLuc = () => {
    const [keHoach, setKeHoach] = useState('Chọn đề kiểm tra năng lực')
            ...
            <div className="them_danhgia_buoc2" id="lo4" >
                <div className="body_them_kehoach" >
                    <div className='max-[600px]:flex-col flex justify-center sm:items-center'>
                        <div className='w-60'>
                            <h4 className="font_ss16 font_wB mr_10 color-blue">Đề kiểm tra năng lực:</h4>
                        </div>
                    ...
                    <div className="show_cauhoide">
                        <div className="cauhoi_chitiet cauhoi_chitiet_1 mb_20">
                            ...
                            <div className="d_flex align_c mb_20">
