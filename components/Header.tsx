...
import titleArray from './tester2';
import { useRouter } from 'next/router';
import { redirect } from 'next/navigation';
import close from '@/public/assets/img/tuychinh_2.png'
...
const Header = () => {
    ...
    useEffect(() => {
      ...
      console.log('check',sessionStorage.getItem('title'))
    return (
        <>
                <div className={`${'sidebar open_toggle'}${toggle ? "" : " set_opentogg"}`}>
                    {
                        (sessionStorage.getItem('title') === 'staff') ? (
                            <Navbar title={0}/>
                        ):(
                            <Navbar title={1}/> 
                        )
                ...
                <div className="header">
                    <div className='box_header d_flex space_b align_c position_r'>
                        ...
                        <div className="header_right d_flex flex_end align_c">
                            ...
                            <div className="header_icon d_flex align_c ">
                                <div className="icon_thongbao" id="icon_nhantin">
                                    <div className="Image_icon position_r" onClick={showPopUpMessage}>
                                ...
                                <div className="icon_thongbao" id="icon_nhacnho">
                                    <div className="Image_icon position_r " onClick={showPopUpRemind}>
                                        ...
                                        <span className={`sl_tb color_t position_a d_flex align_c space_around`} >2</span>
                                    </div>
                                </div>
                                <div className="icon_thongbao" id="icon_thongbao">
                                    <div className="Image_icon position_r " onClick={showPopUpNotice}>
                        ...
                        <div className={`${checkNotice ? `${"hidden"}` : `${"popup_tb_nc position_a"} ${"block"}`}`} id="popup_thongbao">
                            <div className=" border_r10">
                                <div className="popup_tb_nc_header d_flex space_b ">
                                    ...
                                    <div className='ml-32 mt-1'>
                                        <Image src={close} alt='close' onClick={() =>{setCheckNotice(!checkNotice)}}/>
                                    </div>
                                </div>
                        ...
                        <div className={`${checkRemind ? "popup_tb_nc position_a" : "popup_tb_nc position_a block"}`} id="popup_nhacnho">
                            <div className=" border_r10">
                                <div className="popup_tb_nc_header d_flex space_b align_c back_w">
                                    ...
                                    <div className='ml-32'>
                                        <Image src={close} alt='close'  onClick={() =>{setCheckRemind(!checkRemind)}}/>
                                    </div>
                                </div>
                                <div className="popup_tb_nc_body">
                                    <div className="popup_tb_nn_main">
                        ...
                        <div className={`${checkMessage ? "popup_tb_nc position_a" : "popup_tb_nc position_a block"}`} id="popup_tinnhan" >
                            <div className=" border_r10">
                                <div className="popup_tb_nc_header d_flex space_b align_c back_w">
                                    ...
                                    <div className='ml-32'>
                                        <Image src={close} alt='close' onClick={() =>{setCheckMessage(!checkMessage)}}/>
                                    </div>
                                </div>
                                    ...
                                    <div className="box_modal_tinnhan">
                                        <div className="search_tn_md">
                                            <div className="position_r w_100">
                                                <input type="text" className="input_search_md set_border_tn" placeholder="Tìm kiếm trên chat" />
