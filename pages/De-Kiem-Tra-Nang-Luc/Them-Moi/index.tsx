...
const Page = () => {
    ...
    const handleSetLoai = (event: string) => {
     ...
     const [filteredStatement, setFilteredStatement] = useState(LoaiArray);
     const handleStatement = (query: string) => {
         const filteredResults = LoaiArray.filter(item =>
    ...
    const [titleStatement1, setTitleStatement1] = useState('Mở')
    const [stateOn1, setStateOn1] = useState(true)
    const [filteredStatement1, setFilteredStatement1] = useState(searchStatement);
    const handleStatement1 = (query: string) => {
        const filteredResults = searchStatement.filter(item =>
            item.toLowerCase().includes(query.toLowerCase())
        );
        setFilteredData(filteredResults);
    };
    const handleInputStatement1 = (event: any) => {
                    ...
                    <div className="body width_100">
                        ...
                        <form className="form form_tieuchi form_them_tieuchi form_them_tieuchi_con" >
                                            ...
                                            <div /*style="margin-top: 5px;"*/ data-select2-id="select2-data-62-gug4 " className='mt-1' onClick={handleOnQues}>
                                                ...
                                                <span className="select2 select2-container select2-container--default select2-container--below w-full " dir="ltr" data-select2-id="select2-data-47-5f4m" /*style="width: 125.725px;"*/ >
                                                    <span className="selection">
                                                        <span className="select2-selection select2-selection--multiple set_min_height250px"  aria-haspopup="true" aria-expanded="false" tabIndex={-1} aria-disabled="false">
                                            ...
                                            <div className="form_group">
                                                ...
                                                <div className="select_no_muti">
                                                    ...
                                                    onClick={()=>{
                                                        ...
                                                        <span className="selection">
                                                        <ul className={`${"set_selection_type z-50"} ${stateOn[index] ? 'hidden' : ''}`} >
                            ...
                            <div className="form_btn d_flex content_c mt_25">
                                ...
                                <button type="button" className="ajax_them_tc btn btn_xanh btn_168 outline_none" onClick={handleOnPhanLoai}>Lưu</button>
                            </div>
                        </form>
