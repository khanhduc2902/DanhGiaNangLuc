                        ...
                        <div className={`${"bangchung"} `} id="scrollableContent">
                            <table className={`${"bangchinh chuden"} ${""}`} >
                                <tbody><tr>
                                    ...
                                    <th>
                                        <p className="phantucon w-80">Tên đề kiểm tra</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-80">Người tạo</p>
                                    </th>
                
                                    <th>
                                        <p className="phantucon w-28">Số câu hỏi</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-80">Ghi chú</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-36">Ngày xóa</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-52">Chức năng</p>
                                    </th>
                                </tr>
                                    {
                                    filteredDataStaff.map((item,index) =>{
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td className='text-left'>
                                                    ...
                                                    <div className="flex center-height">
                                                        ...
                                                        <p className="size-14 left-10">{item.name}</p>
                                                     
                                                    </div>
                                                </td>
                                                <td className="">{item.obNum}</td>
                                                <td>{item.ob}</td>
