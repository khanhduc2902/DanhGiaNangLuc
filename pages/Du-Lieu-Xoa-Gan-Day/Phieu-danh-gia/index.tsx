                    ...
                    <div className="khoibang po_r">
                        ...
                        <div className={`${"bangchung"} `} id="scrollableContent">
                            <table className={`${"bangchinh chuden"} ${""}`} >
                                <tbody><tr>
                                    <th>
                                        <p className="phantucon w-14">STT</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-28 p-0.5">Mã phiếu</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-80">Tên kế hoạch đánh giá</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-36 p-0.5">Trạng thái</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-32">Đối tượng</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-28 p-0.5">Số đối tượng</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-60">Thời gian</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-44">Người đánh giá</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-80">Ghi chú</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-48">Chức năng</p>
                                    </th>
                                </tr>
                                    {
                                    filteredDataStaff.map((item,index) =>{
                                        ...
                                        <td className="chuxanh text-left font-medium">{item.id}</td>
                                        <td className='text-left font-medium'>{item.name}</td>
                                        <td className="chuxanh">{item.state}</td>
                                        <td>{item.ob}</td>
                                        <td>{item.obNum}</td>
