...
const Page = () => {
    ...
    const [staff, setStaff] = useState('Tìm kiếm theo tiêu đề đánh giá')
                ...
                <div className="tieuchidanhgia box-qlinhanvien">
                    ...
                    <div className="khoidanhmuc ">
                        <div className="khoidanhmuccon">
                            <Link href="Tieu-chi" className={`${"tendanhmuccon size-14"} ${namePath.startsWith('/Du-Lieu-Xoa-Gan-Day/Tieu-chi') ? 'chuxanhdam' : ''}`}>Tiêu chí
                                đánh giá</Link>
                            <div className={`${"border "} ${namePath.startsWith('/Du-Lieu-Xoa-Gan-Day/Tieu-chi') ? "border-active" : ''}`}></div>
                        </div>
                        <div className="khoidanhmuccon">
                            <Link href="Tieu-de" className={`${"tendanhmuccon size-14"} ${namePath.startsWith('/Du-Lieu-Xoa-Gan-Day/Tieu-de') ? 'chuxanhdam' : ''}`}>Đề đánh giá</Link>
                            <div className={`${"border "} ${namePath.startsWith('/Du-Lieu-Xoa-Gan-Day/Tieu-de') ? "border-active" : ''}`}></div>
                        </div>
                    </div>
                        ...
                        <div className={`${"bangchung"} `} id="scrollableContent">
                            <table className={`${"bangchinh chuden"} ${""}`} >
                                <tbody><tr>
                                    ...
                                    <th>
                                        <p className="phantucon">Tên mẫu tiêu chí đánh giá</p>
                                    </th>
                                    <th>
                                        <p className="phantucon w-28">Người tạo</p>
                                    </th>
                                    <th>
                                    ...
                                    <tr>
                                        <td><input className="wh16 js_checkbox" type="checkbox" value="10" /></td>
                                        <td className="chuxanh text-left font-medium">Đề1</td>
                                        <td className="">
                                        ...
                                        <td className="text-left"><em className='xoadulieu_tieude'>Anh rất tốt thế nhưng thà đừng gặp vui hơn<br/>
                                            Em rất tiếc thế nhưng thà làm người cô đơn<br/>
                                                Sẽ chẳng phải thốt lên hài hước như lúc này<br/>
                                                    Rằng mẹ anh bắt chia tay.<br/>
                                                        Anh cũng rất tốt thế nhưng mình chẳng hợp nhau đâu<br/>
                                                            Em có chút tiếc nuối khi mình chẳng phải cô dâu<br/>
                                                                Em sẽ ghé đám cưới anh và nói lời này:<br/>
                                                                    “Chúc anh hạnh phúc, chỉ một ngày!”</em></td>
                                                            <td>2023-03-14 15:39:48</td>
                                                            <td>
                                                                <div className="flex center-height space">

                                                                    <Image src={khoiphuc} className="" alt="khooi phuc" />
                                                                        <p data-name="Đề1" data-id="10" className="chuxanh js_khoiphuc c-pointer font-medium size-14">Khôi phục
                                                                        </p>

                                                                        <p className="chuxanh right-5 left-5">|</p>

                                                                        <Image src={xoa} className="" alt="khooi phuc" />
                                                                            <p data-name="Đề1" data-id="10" className="chudo js_xoa c-pointer font-medium size-14">Xóa
                                                                            </p>
