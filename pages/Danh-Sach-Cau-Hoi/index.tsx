...
const pointArray = ['Tất cả hình thức câu hỏi', 'Tự luận', 'Trắc nghiệm', 'Hộp kiểm']
...
const PhieuDanhGia = () => {
    ...
    const [keHoach, setKeHoach] = useState('Tìm kiếm theo tên câu hỏi, loại câu hỏi')
    ...
    const [staff, setStaff] = useState('Tất cả loại câu hỏi')
    ...
    const [point, setPoint] = useState('Tất cả hình thức câu hỏi')
                ...
                <div className="main_body">
                    <div className="phieudanhgia box-qlinhanvien">
                        ...
                        <div className="flex wrap">
                            <div className={`${"select_no_muti danhmucdanhgia"} ${'w-80 relative text-sm border border-slate-300 mb-3 mr-4'}`}>
                                <div className='flex cursor-pointer' onClick={handleDanhGia}>
                                    <p className='pl-3 py-2 w-72 truncate'>{staff}</p>
                                    <span className="mr-3 pt-4" role="presentation"><Image src={imageFile.icon_so} alt=""></Image></span>
                                </div>
                                <ul className={danhGia ? 'hidden' : `${"js_select_2 absolute z-50 w-80 bg-white overflow-y-scroll h-20 rounded-b-md border border-x-slate-400 border-b-slate-400 "} ${'displaynone_scroll'} `}>
                                    <li className='m-1 ml-2'><input type="search" className='py-1 px-3 w-full border border-slate-400 outline-none' onChange={handleInputChangeStaff} value={searchStaff} /></li>

                                    {
                                        filteredDataStaff.map((item, index) => {
                                            return (
                                                <li key={index} className='hover:bg-blue-400  hover:text-white  cursor-pointer py-1.5 px-1' value="2672"
                                                    onClick={() => {
                                                        setStaff(item);
                                                        setDanhGia(!danhGia)
                                                    }}
                        ...
                        <div className="search-qlnv justify-between">
                            ...
                            <div className='flex'>
                                <div className="them_moi max-sm:mb-6">
                                    <Link href="/Danh-Sach-Cau-Hoi/Them-Moi" className="btn btn_xanh">
                                ...
                                <div className='bangchung' id="bang_chung">
                                    <table className='bangchinh tieu_chi'>
                                        <tbody><tr>
                                            ...
                                            <th className='w-36'>
                                                <p className='phantucon'>Hình thức</p>
                                            </th>
                                            ...
                                            <th className='w-52'>
                                                <p className='phantucon'>Thời gian thực hiện (phút)</p>
                                            </th>
                                            <th className='w-52'>
                                                <p className='phantucon'>Người cập nhật</p>
                                            </th>
                                            <th className='w-52'>
                                                <p className='phantucon'>Ngày cập nhật</p>
                                            </th>
                                            <th className='w-36'>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div /*style="width: 370px;"*/>
                                                        <p className="text_a_l elipsis1"><Link className="color_blue elipsis1" href="/Danh-Sach-Cau-Hoi/Chi-Tiet">tgfdgdfg</Link>
                                                        </p>
                                                    </div>
                                                ...
                                                <td className="">
                                                    <div /*style="width: 190px;"*/ className="d_flex align_c">
                                                        <div className="img  ">
                                                ...
                                                <td className="">
                                                    <p>16:33 - 29/07/2023</p>
                                                </td>
                                                <td>
                                                    <div className="sua_xoa d_flex content_c ">
                                                        <Link href="/Danh-Sach-Cau-Hoi/Chinh-Sua" className="btn_chinhsua position_r d_flex mr_10 edit_loaicauhoi">
                                                        ...
                                                        <div data-id="427" className="btn_xoa d_flex c-pointer" onClick={handleXoaQues}>
                                                            <div className="img mr_5">
                        ...
                        <div className="container">
                            <div className="content">
                                ...
                                <div className="popup_body">
                                    <p className="cont_1">Bạn có chắc chắn muốn xóa câu hỏi này không ? <span /*style="width: 300px; margin-left: -30px;"*/ className="font_wB show_xoa_ten elipsis1"></span></p>
